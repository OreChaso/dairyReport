...
try {
  ...
  // if(!$user_id) {
  //   throw new Exception('ユーザーIDが不正です', 500);
  // }
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($err)) {
      ...
      $stmt->bindValue(':users_id',(int)$user_id,PDO::PARAM_INT);
...
<form class="border rounded bg-white time-table" action ="./user_result.php" method="get">
  ...
  <div class="float-right">
    <a href="/admin/user_lists.php"><button type="button" class="btn btn-secondary rounded-pill px-5">社員一覧に戻る</button></a>
  </div>
